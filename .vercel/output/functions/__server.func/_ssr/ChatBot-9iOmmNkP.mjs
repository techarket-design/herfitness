...
//#region node_modules/.nitro/vite/services/ssr/assets/ChatBot-9iOmmNkP.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var WHATSAPP_NUMBER = "919990009580";
...
function WhatsAppButton() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
		...
		onClick: () => {
			if (typeof window !== "undefined" && window.fbq) window.fbq("trackCustom", "WhatsAppClick");
		},
