...
//#region node_modules/.nitro/vite/services/ssr/assets/trainers-BeT8uG4g.js
...
var TRAINERS = [
	...
	},
	{
		...
		years: 10,
		bio: "Kavya trained in Sydney and Mumbai before joining us. She runs Delhi's only fully women-only Reformer room in Prashant Vihar.",
		image: IMAGES.trainers.trainer1,
	...
	},
	{
		...
		years: 8,
		bio: "Juhi runs our new-member onboarding. If you've never been to a gym before, she's your first coach.",
		image: IMAGES.trainers.trainer2,
		instagram: "#",
