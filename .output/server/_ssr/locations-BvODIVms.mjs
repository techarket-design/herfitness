//#region node_modules/.nitro/vite/services/ssr/assets/locations-BvODIVms.js
...
var hero_default = "/assets/hero-B1S2zmaL.jpg";
...
var IMAGES = {
	...
	locations: {
		"punjabi-bagh": {
			hero: program_strength_default,
			about: transform_1_default,
			gallery: [
		...
		"rajouri-garden": {
			hero: program_dance_default,
			about: transform_2_default,
			gallery: [
				program_dance_default,
				transform_2_default,
		...
		"paschim-vihar": {
			hero: program_yoga_default,
			about: transform_3_default,
			gallery: [
				program_yoga_default,
				transform_3_default,
				program_strength_default,
