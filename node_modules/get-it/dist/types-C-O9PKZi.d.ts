 ...
 * @public
 */
type WrappingMiddleware = (options: RequestOptions, next: (opts: RequestOptions) => Promise<BufferedResponse>) => Promise<BufferedResponse>;
/**
 ...
 * @public
 */
type DefaultResponse<As extends 'json' | 'text' | 'stream' | undefined = undefined> = As extends 'json' ? JsonResponse : As extends 'text' ? TextResponse : As extends 'stream' ? StreamResponse : BufferedResponse;
/**
 ...
 * @public
 */
interface RequestFunction<DefaultAs extends 'json' | 'text' | 'stream' | undefined = undefined> {
  <T = unknown>(options: RequestOptions & {
    as: 'json';
...
export { FetchHeaders as a, RequestFunction as c, StreamResponse as d, TextResponse as f, WrappingMiddleware as h, FetchFunction as i, RequestOptions as l, TransformMiddleware as m, DefaultResponse as n, FetchInit as o, TimeoutOptions as p, FetchBody as r, JsonResponse as s, BufferedResponse as t, RequesterOptions as u };
//# sourceMappingURL=types-C-O9PKZi.d.ts.map