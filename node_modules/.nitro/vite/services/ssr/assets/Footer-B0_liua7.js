...
import { ChevronDown, Facebook, Instagram, Mail, MapPin, Menu, Phone, X, Youtube } from "lucide-react";
	...
	return /* @__PURE__ */ jsxs("header", {
		...
		children: [/* @__PURE__ */ jsxs("nav", {
			...
			children: [
				...
				/* @__PURE__ */ jsxs("ul", {
					...
					children: [links.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
						...
						children: l.label
					}) }, l.label)), /* @__PURE__ */ jsxs("li", {
						className: "relative",
						onMouseEnter: () => setLocOpen(true),
						onMouseLeave: () => setLocOpen(false),
						children: [/* @__PURE__ */ jsxs("button", {
							className: "flex items-center gap-1 hover:text-primary transition-colors",
							children: ["Locations ", /* @__PURE__ */ jsx(ChevronDown, { className: "h-3.5 w-3.5" })]
						}), locOpen && /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsx("div", { className: "my-1 h-px bg-border/60" }),
									LOCATIONS.map((loc) => /* @__PURE__ */ jsxs(Link, {
										...
										children: [/* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-primary" }), loc.name]
									}, loc.slug))
								]
							})
						})]
			...
			children: /* @__PURE__ */ jsxs("ul", {
				...
				children: [
					links.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(Link, {
						to: l.to,
						hash: l.hash,
					...
					/* @__PURE__ */ jsxs("li", {
						...
						children: [/* @__PURE__ */ jsx("p", {
							...
							children: LOCATIONS.map((loc) => /* @__PURE__ */ jsx(Link, {
								to: "/locations/$location",
								params: { location: loc.slug },
...
function Footer() {
	return /* @__PURE__ */ jsxs("footer", {
		...
		children: [/* @__PURE__ */ jsx("div", { className: "absolute -top-20 left-1/2 h-64 w-[80%] -translate-x-1/2 rounded-full bg-primary/30 blur-3xl" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
						...
						].map((item) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("a", {
							href: item.h,
					...
					/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h4", {
						...
						children: [
							/* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4 text-primary" }), " +91 99900 09580"]
							}),
							/* @__PURE__ */ jsxs("li", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(Mail, { className: "h-4 w-4 text-primary" }), " joinherfitness@gmail.com "]
							}),
							/* @__PURE__ */ jsx("li", { children: "8 studios · Delhi NCR" })
						]
					})] })
				]
			}), /* @__PURE__ */ jsxs("div", {
...
//#endregion
export { cn as i, Navbar as n, Button as r, Footer as t };
