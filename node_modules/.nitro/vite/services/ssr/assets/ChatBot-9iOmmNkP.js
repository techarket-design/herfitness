...
function WhatsAppButton() {
	return /* @__PURE__ */ jsxs("a", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "absolute inset-0 -z-10 rounded-full bg-[#25D366] opacity-60 animate-ping" }), /* @__PURE__ */ jsx("span", {
...
function ChatBot() {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("button", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: `absolute inset-0 -z-10 rounded-full bg-primary opacity-60 ${open ? "" : "animate-ping"}` }), /* @__PURE__ */ jsx("span", {
			...
			children: open ? /* @__PURE__ */ jsx(X, { className: "h-5 w-5 sm:h-6 sm:w-6" }) : /* @__PURE__ */ jsx(MessageCircle, { className: "h-5 w-5 sm:h-6 sm:w-6" })
		})]
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx("div", { className: "absolute -top-10 -right-8 h-32 w-32 rounded-full bg-white/20 blur-2xl pointer-events-none" }),
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-green-300 animate-pulse" }), " Online · Replies instantly"]
						})] })]
					}),
					/* @__PURE__ */ jsx("button", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					step >= 0 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Bubble, {
						from: "bot",
						delay: .2,
						children: [/* @__PURE__ */ jsx("b", { children: "Step 1 of 3" }), " — what should we call you?"]
					}), lead.name && /* @__PURE__ */ jsx(Bubble, {
						from: "user",
						children: lead.name
					})] }),
					step >= 1 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Bubble, {
						from: "bot",
						delay: .15,
						children: [
							"Lovely to meet you, ",
							...
							"! ✨ ",
							/* @__PURE__ */ jsx("br", {}),
							/* @__PURE__ */ jsx("b", { children: "Step 2 of 3" }),
							" — your WhatsApp number, so we can confirm your slot?"
						]
					}), lead.phone && /* @__PURE__ */ jsx(Bubble, {
						from: "user",
						children: lead.phone
					})] }),
					step >= 2 && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs(Bubble, {
						from: "bot",
						delay: .15,
						children: [/* @__PURE__ */ jsx("b", { children: "Step 3 of 3" }), " — pick your primary goal and closest studio 👇"]
					}), lead.goal && lead.branch && /* @__PURE__ */ jsxs(Bubble, {
						from: "user",
						children: [
							lead.goal,
							" · ",
					...
					status === "sending" && /* @__PURE__ */ jsxs(Bubble, {
						from: "bot",
						children: [/* @__PURE__ */ jsx(Loader2, { className: "inline h-4 w-4 animate-spin mr-2" }), " Booking your trial slot…"]
					}),
					status === "sent" && /* @__PURE__ */ jsxs(Bubble, {
						from: "bot",
						children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "inline h-4 w-4 text-primary mr-1" }), "You're all set! Our studio team will WhatsApp you within 2 hours 💖"]
					}),
					status === "error" && /* @__PURE__ */ jsx(Bubble, {
						from: "bot",
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: status === "sent" || status === "error" ? /* @__PURE__ */ jsx("button", {
					onClick: reset,
				...
				}, "name") : step === 1 ? /* @__PURE__ */ jsx(TextField, {
					type: "tel",
				...
				}, "phone") : step === 2 ? /* @__PURE__ */ jsxs("div", {
					className: "space-y-3",
					children: [
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: GOALS.map((g) => /* @__PURE__ */ jsx("button", {
								onClick: () => setLead((l) => ({
									...l,
									goal: g
								})),
						...
						/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("p", {
							...
							children: BRANCHES.map((b) => /* @__PURE__ */ jsx("button", {
								onClick: () => setLead((l) => ({
									...l,
									branch: b
								})),
						...
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-4 w-4" }), " Book My Free Trial"]
						})
					]
				}) : null
			})
