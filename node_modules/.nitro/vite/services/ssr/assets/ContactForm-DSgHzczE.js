import { t as LOCATIONS } from "./locations-Dfz4tujt.js";
import { r as Button } from "./Footer-CeJxoXe3.js";
import { t as Input } from "./input-KU6fiyN1.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, o as Label, r as SelectItem, s as Textarea, t as Select } from "./select-BKRE1dCC.js";
...
function ContactForm() {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "absolute -top-24 -left-24 h-96 w-96 rounded-full bg-primary/25 blur-3xl" }),
			/* @__PURE__ */ jsx("div", { className: "absolute -bottom-24 -right-24 h-96 w-96 rounded-full bg-accent/30 blur-3xl" }),
			/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							/* @__PURE__ */ jsxs("span", {
								...
								children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-primary" }), " Book Your Free Trial"]
							}),
							/* @__PURE__ */ jsxs("h2", {
							...
							/* @__PURE__ */ jsx("ul", {
								...
								children: [
									...
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ jsx("span", { children: p })]
								}, p))
							})
						]
						...
						children: [
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, {
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, {
										className: "mt-2 rounded-xl bg-white/70",
										children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Choose a studio" })
									}), /* @__PURE__ */ jsx(SelectContent, { children: LOCATIONS.map((loc) => /* @__PURE__ */ jsxs(SelectItem, {
										value: loc.name,
										children: [
											loc.name,
											" (",
									...
									children: [/* @__PURE__ */ jsx(SelectTrigger, {
										className: "mt-2 rounded-xl bg-white/70",
										children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "What matters most?" })
							...
							/* @__PURE__ */ jsx(Button, {
								...
								children: status === "loading" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), " Sending…"] }) : status === "success" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "mr-2 h-4 w-4" }), " We'll be in touch!"] }) : "Claim My Free Trial"
							}),
