...
//#region src/components/site/VideoBlock.tsx
var heights = {
	sm: "min-h-[60vh]",
	md: "min-h-[75vh]",
	lg: "min-h-[92vh]"
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [
			/* @__PURE__ */ jsxs(motion.div, {
				...
				children: [!errored && src ? /* @__PURE__ */ jsx("video", {
					ref: videoRef,
			...
			/* @__PURE__ */ jsx("div", { className: "absolute -top-24 left-1/3 h-72 w-72 rounded-full bg-primary/40 blur-3xl animate-float" }),
