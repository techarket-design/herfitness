...
import { t as Route } from "./services._service-BlJSxxUW.js";
...
import { ArrowRight, Calendar, CheckCircle2, Clock, Flame, Sparkles, Users } from "lucide-react";
//#region src/routes/services.$service.tsx?tsr-split=component
var stagger = {
	hidden: { opacity: 0 },
	show: {
		opacity: 1,
...
function ServicePage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
							...
							children: [
								/* @__PURE__ */ jsxs(motion.div, {
									...
									children: [
										...
										/* @__PURE__ */ jsx("span", { children: "/" }),
										/* @__PURE__ */ jsx("span", { children: svc.title })
									]
								}),
					...
					children: [/* @__PURE__ */ jsxs(motion.div, {
						...
						children: [
							...
							/* @__PURE__ */ jsx(motion.ul, {
								...
								children: svc.highlights.map((h) => /* @__PURE__ */ jsxs(motion.li, {
									variants: rise,
						...
						children: svc.benefits.map((b, i) => /* @__PURE__ */ jsxs(motion.div, {
							variants: rise,
							whileHover: { y: -4 },
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: svc.weeklyFlow.map((line, i) => /* @__PURE__ */ jsxs(motion.div, {
							initial: {
								opacity: 0,
								y: 20
							},
							...
							children: [/* @__PURE__ */ jsx(Calendar, { className: "mt-0.5 h-4 w-4 shrink-0 text-primary" }), /* @__PURE__ */ jsx("p", {
			...
			svc.faqs.length > 0 && /* @__PURE__ */ jsx("section", {
				className: "py-24 sm:py-32",
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", {
							...
							className: "mt-4 text-4xl sm:text-5xl",
							children: ["Before you book ", /* @__PURE__ */ jsx("em", {
								className: "text-gradient-rose",
								children: svc.title
							})]
						})]
						...
						children: svc.faqs.map((f, i) => /* @__PURE__ */ jsxs(AccordionItem, {
							value: `item-${i}`,
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("span", {
							...
							className: "mt-4 text-4xl sm:text-5xl",
							children: ["Also popular ", /* @__PURE__ */ jsx("em", {
								className: "text-gradient-rose",
								children: "with her."
							})]
						})] }), /* @__PURE__ */ jsxs(Link, {
