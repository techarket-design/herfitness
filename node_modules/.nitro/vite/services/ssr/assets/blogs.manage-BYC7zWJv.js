import { a as publishSanityBlog, i as getSanityConfig, o as saveSanityConfig, r as fetchSanityBlogs, s as BLOG_CATEGORIES, t as deleteSanityBlog } from "./sanity-clmAvCgk.js";
import { n as Navbar, r as Button, t as Footer } from "./Footer-BBronO8e.js";
import { t as Input } from "./input-BL1NwRLK.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, o as Label, r as SelectItem, s as Textarea, t as Select } from "./select-8cBafUlY.js";
import { useEffect, useState } from "react";
import { Link } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { AlertCircle, ArrowLeft, BookOpen, CheckCircle2, Edit3, ExternalLink, Eye, Key, Loader2, Plus, RefreshCw, Sparkles, Trash2 } from "lucide-react";
//#region src/routes/blogs.manage.tsx?tsr-split=component
function BlogManagementPage() {
	...
	const [dataDist, setDataDist] = useState("fallback");
	...
	const [date, setDate] = useState((/* @__PURE__ */ new Date()).toLocaleDateString("en-US", {
		month: "short",
		day: "numeric",
		year: "numeric"
	}));
	...
	const [keyTakeaways, setKeyTakeaways] = useState(["Combine lentils and whole grains for complete protein.", "Prioritize daily bioavailable protein sources for metabolic recovery."]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs(Link, {
								...
								children: [/* @__PURE__ */ jsx(ArrowLeft, { className: "h-4 w-4" }), " Back to Journal"]
							}), /* @__PURE__ */ jsxs("h1", {
								className: "font-display text-4xl sm:text-5xl",
								children: ["Sanity Blog ", /* @__PURE__ */ jsx("em", {
								...
								children: [/* @__PURE__ */ jsxs(Button, {
									...
									children: [/* @__PURE__ */ jsx(Key, { className: "h-4 w-4 text-primary" }), " Sanity API Setup"]
								}), /* @__PURE__ */ jsx(Button, {
									onClick: loadBlogs,
									variant: "ghost",
									size: "icon",
						...
						/* @__PURE__ */ jsx("div", {
							className: "mt-6",
							children: sanityConfig.isConfigured ? /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-emerald-500 shrink-0" }), /* @__PURE__ */ jsxs("div", { children: [
										/* @__PURE__ */ jsx("span", {
								...
								children: [/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5 text-amber-500 shrink-0 mt-0.5" }), /* @__PURE__ */ jsxs("div", {
										className: "text-sm",
						...
						feedback && /* @__PURE__ */ jsxs("div", {
							...
							children: [feedback.type === "success" ? /* @__PURE__ */ jsx(CheckCircle2, { className: "h-5 w-5 text-emerald-500 shrink-0" }) : /* @__PURE__ */ jsx(AlertCircle, { className: "h-5 w-5 text-destructive shrink-0" }), /* @__PURE__ */ jsx("p", {
								className: "flex-1",
									...
									children: [
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ jsx("h2", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Label, {
													...
													}), /* @__PURE__ */ jsx(SelectContent, { children: BLOG_CATEGORIES.filter((c) => c !== "All").map((c) => /* @__PURE__ */ jsx(SelectItem, {
														value: c,
														children: c
													}, c)) })]
												})] }),
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [
												...
												/* @__PURE__ */ jsx("ul", {
													...
													children: keyTakeaways.map((point, idx) => /* @__PURE__ */ jsxs("li", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("div", {
												...
												children: [/* @__PURE__ */ jsxs(Label, {
													...
													children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5 mr-1" }), " Add Section"]
												})]
											}), sections.map((sec, sIdx) => /* @__PURE__ */ jsxs("div", {
										...
										/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("label", {
												...
												children: submitting ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), " Publishing…"] }) : /* @__PURE__ */ jsxs(Fragment, { children: [
								...
								children: /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
											...
											size: "sm",
											className: "rounded-full text-xs",
											children: [/* @__PURE__ */ jsx(Plus, { className: "h-3.5 w-3.5 mr-1" }), " New"]
										})]
									}), loading ? /* @__PURE__ */ jsxs("div", {
										className: "py-12 text-center text-sm text-muted-foreground",
										children: [/* @__PURE__ */ jsx(Loader2, { className: "h-6 w-6 animate-spin mx-auto mb-2 text-primary" }), " Loading articles..."]
									}) : /* @__PURE__ */ jsx("div", {
										className: "space-y-3 max-h-[750px] overflow-y-auto pr-1",
										children: posts.map((p) => /* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsx("div", {
												...
												children: [/* @__PURE__ */ jsxs(Link, {
													...
													children: [/* @__PURE__ */ jsxs("button", {
														...
														children: [/* @__PURE__ */ jsx(Edit3, { className: "h-3.5 w-3.5" }), " Edit"]
													}), /* @__PURE__ */ jsxs("button", {
			...
			showConfigModal && /* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								className: "flex items-center gap-2",
								children: [/* @__PURE__ */ jsx(Key, { className: "h-5 w-5 text-primary" }), /* @__PURE__ */ jsx("h3", {
						...
						/* @__PURE__ */ jsxs("p", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("b", { children: "Project ID" }),
								" and an ",
								/* @__PURE__ */ jsx("b", { children: "API Write Token" }),
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("p", {
										...
										children: [
											/* @__PURE__ */ jsxs("li", { children: ["Go to ", /* @__PURE__ */ jsxs("a", {
												href: "https://www.sanity.io/manage",
												target: "_blank",
												rel: "noreferrer",
												className: "text-primary underline inline-flex items-center gap-0.5",
												children: ["sanity.io/manage ", /* @__PURE__ */ jsx(ExternalLink, { className: "h-3 w-3" })]
											})] }),
											/* @__PURE__ */ jsx("li", { children: "Create or select your project & copy the Project ID." }),
											/* @__PURE__ */ jsx("li", { children: "Go to API tab → Tokens → Add Token (Permissions: Editor)." })
										]
									})]
								}),
								/* @__PURE__ */ jsxs("div", {
