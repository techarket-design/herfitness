import { s as hero_default } from "./locations-Crohst2h.js";
import { r as fetchSanityBlogs, s as BLOG_CATEGORIES } from "./sanity-CDJwZIE_.js";
...
import { ArrowUpRight, BookOpen, Calendar, Clock, Edit3, Mail, Search, Sparkles } from "lucide-react";
...
function BlogsIndexPage() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx(Sparkles, { className: "h-3.5 w-3.5 text-primary" }), " The Her Fitness Journal"]
									}), /* @__PURE__ */ jsxs(Link, {
										to: "/blogs/manage",
										...
										children: [/* @__PURE__ */ jsx(Edit3, { className: "h-3.5 w-3.5 text-primary" }), " Sanity Studio"]
									})]
								}),
								/* @__PURE__ */ jsxs("h1", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx(Search, { className: "ml-3 h-5 w-5 text-white/60 shrink-0" }), /* @__PURE__ */ jsx("input", {
										type: "text",
										value: searchQuery,
			...
			!searchQuery && selectedCategory === "All" && featuredPost && /* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-4 w-4 text-primary" }), /* @__PURE__ */ jsx("span", {
								className: "text-xs uppercase tracking-[0.25em] text-primary font-medium",
								children: "Featured Article"
							})]
						}), dataSource === "sanity" && /* @__PURE__ */ jsx("span", {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("div", {
										...
										children: [featuredPost.author.avatar ? /* @__PURE__ */ jsx("img", {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: BLOG_CATEGORIES.map((cat) => /* @__PURE__ */ jsx("button", {
					...
					}) : filteredPosts.length === 0 ? /* @__PURE__ */ jsxs("div", {
						...
						children: filteredPosts.map((post, i) => /* @__PURE__ */ jsx(motion.div, {
							initial: {
								opacity: 0,
								y: 20
							},
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Mail, { className: "h-3.5 w-3.5" }), " Her Fitness Digest"]
						}),
						/* @__PURE__ */ jsxs("h2", {
							className: "mt-4 font-display text-4xl sm:text-5xl",
							children: ["Wellness tips delivered to ", /* @__PURE__ */ jsx("em", {
								className: "text-gradient-rose",
								children: "your inbox."
							})]
						}),
