...
import { C as createErrorClass, S as arrRemove, T as isTimeoutError, _ as identity, a as defineRequester, b as EMPTY_SUBSCRIPTION, c as isHttpError$1, d as from, f as executeSchedule, g as Observable, h as operate, i as _defineProperty, l as isQueryParseError, m as createOperatorSubscriber, n as CorsOriginError, o as formatQueryParseError, p as innerFrom, r as ServerError, t as ClientError, v as SafeSubscriber, w as isFunction, x as Subscription, y as errorContext } from "./request-BhMuKj0D-BPt1W1VI.js";
import { c as __read, d as __values, o as __extends, u as __spreadArray } from "./tslib.es6-6sk7YbJQ.js";
import { a as getVersionId, h as w, i as getVersionFromId, n as getDraftId, o as isDraftId, r as getPublishedId, s as isVersionId } from "./resolveEditInfo-Cz-smq3a-BYyFTRaP.js";
...
//#endregion
//#region node_modules/@sanity/client/node_modules/nanoid/index.browser.js
...
function _fetch$1(client, httpRequest, _stega, query, _params = {}, options = {}) {
	...
	return stega.enabled ? Promise.all([request, import("./stegaEncodeSourceMap-YR3NQ3iz-SCVvkFFD.js").then((n) => n.n)]).then(([res, { stegaEncodeSourceMap }]) => {
...
function _upload(client, _httpRequest, assetType, body, opts = {}) {
	...
	return typeof XMLHttpRequest < "u" ? defer(async () => {
		let { uploadWithProgress } = await import("./browserUpload-CwpNx7Vl-Bd2r1kVo.js"), req = _prepareRequest(client, { ...baseRequest });
